              ...
              <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                      <img src="./src/adds/1.jpg" alt="Picture not Available" height="150px">
                    </li>
                  </ul>
                  <div class="d-flex">
                    <img src="./src/adds/2.jpg" height="150px">
                  </div>
                </div>
              </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      ...
                      <?php } $i = $i+1;} ?>
                          <div class="card-body">
                            ...
                            <h3 class="card-text mt-5"><span>USD.</span><span><?php echo $row['price']; ?></span></h3>
                            </div>
