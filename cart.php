                    ...
                    <?php 
                        ...
                        while ($row = $result -> fetch_array()) {
                            ...
                            <div style="position:relative;">
                                ...
                                <h3 style="color:#32a852;"><span>$.</span><span id="price"><?php echo $row['product_price'] ?></span></h3>
            ...
            <div class="col-md-6 col-lg-6 col-sm-12">
                <div class="row">
                    ...
                    <div class="mt-3 mb-4 card-body">
                        ...
                        <h4 style="display: flex;justify-content: space-between;" class="card-text"><span>Total Price</span><span><span>$.</span><span id="t_price">0</span></h4>
