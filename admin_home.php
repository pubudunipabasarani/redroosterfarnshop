...
<div class="container">
  <div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      ...
      <a href="index.php"> <img src="employeeimage.jpg" class="card-img-top" alt="..." height="220px"></a>
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Employee</h5>
          <div class="card-text text-black-50">Visit Here To View Employee Information</div>
        </div>
      </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-0 shadow">
      <a href="index2.php"><img src="customersimage1.jpg" class="card-img-top" alt="..." height="220px"></a>
        <div class="card-body text-center">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-0 shadow">
      <a href="index4.php"><img src="productsimage1.jpg" class="card-img-top" alt="..." height="220px"></a>
        <div class="card-body text-center">
